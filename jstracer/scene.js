...
export class Scene {
    constructor() {
        this.lights = [
            new Light(new Vector(5, 5, -5), new Color(0.1, 0.2, 0.3)),
            // new Light(new Vector(-5, 5, -1), new Color(1, 0, 0)),
            // new Light(new Vector(0, -2, 2), new Color(0, 1, 0))
        ];

        this.things = [
            new Plane(new Vector(0, 1, 0), 0, new Chessboard(Color.Black, Color.White)),
            new Sphere(new Vector(-1, 0.1, 0.5), 0.1, new Color(1, 1, 0, 0.5)),
